...
<head>
  ...
  <title>Statement - MacAdmin</title>
...
<div class="content">
        ...
        <ul id="nav">
          ...
          <li class="has_sub open"><a href="#"><i class="fa fa-file-o"></i> Pages #2  <span class="pull-right"><i class="fa fa-chevron-right"></i></span></a>
            <ul>
              ...
              <li class="current"><a href="statement.html">Statement</a></li>
    ...
    <!-- Sidebar ends -->
      ...
      <!-- Page heading -->
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-file-o"></i> Statement</h2>
                ...
                <div class="widget-content">
                  ...
                  <div class="widget-foot">
					...
					<div class="pull-right">
						<a href="#" class="btn btn-danger btn-sm">Send Statement</a>
						<a href="#" class="btn btn-default btn-sm">Delete Statement</a>
					</div>
					<div class="clearfix"></div>
